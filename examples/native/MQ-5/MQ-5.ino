 ...
 *
 * @file        MQ-5.ino
 * @brief       Example for reading gas measurements from MQ5 sensor (native)
 *
...
void loop()
{
  mq5.update();      // Update data, read voltage level from sensor
  Serial.println("CH4: " + String(mq5.readSensor())+"ppm"); // Print the readings to the serial monitor
